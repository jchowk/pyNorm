...
;------------------------------------------------------------------------------
PRO iCOL_BATCH,x,y,ey,ycon,sigma,ycon_sig,wavc,fval,vbatch1,vbatch2, ncol,ncole1,$
