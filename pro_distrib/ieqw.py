...
Use:
	IEQW,x,y,ycon,y_sig,ycon_sig,ew,y_err,ycon_err,zero_err
...
def iEQW(x, y, ycon, y_sig, ycon_sig, ew, y_err, ycon_err, zero_err, root):
    """
    ...
    n_params = 10
    def _ret():  return (x, y, ycon, y_sig, ycon_sig, ew, y_err, ycon_err, zero_err, root)
    ...
    ycon_err = TOTAL((ycon_sig * (y / ycon ** 2) * dx))
    #
